(()=>{
  ...
  function renderRarity(){
    ...
    const line=$('#rarityLine');
    if(line)line.textContent=`${rarity} STANDARD`;
    return rarity;
  }
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ensureRerollButton();
    $('#diagnoseBtn')?.addEventListener('click',()=>setTimeout(reroll,60));
