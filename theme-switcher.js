(()=>{
  ...
  const THEMES={persona:{href:'persona-theme.css?v=0.7.10',label:'COMIC / PHANTOM'},zzz:{href:'zzz-theme-v0710.css?v=0.7.10',label:'URBAN / ACTION'}};
  function applyTheme(name){
    ...
    if(badge)badge.textContent=`v0.7.10 // ${t.label} // 2026-08-18`;
    const footer=[...document.querySelectorAll('#resultCard footer span')].at(-1);if(footer)footer.textContent='TRPG LAB // CoC6 // v0.7.10';
