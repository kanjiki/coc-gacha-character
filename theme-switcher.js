(()=>{
  ...
  const THEMES={persona:{href:'persona-theme.css?v=0.7.0',label:'COMIC / PHANTOM'},zzz:{href:'zzz-theme-v070.css?v=0.7.0',label:'URBAN / ACTION'}};
  function applyTheme(name){
    ...
    if(badge)badge.textContent=`v0.7.0 // ${t.label} // 2026-08-18`;
