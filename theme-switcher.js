(()=>{
  ...
  function ensureRandomBuild(){
    ...
    s.src='random-build.js?v=0.7.25';
    s.defer=true;
  ...
  function ensureSkillSanitizer(){
    ...
    const s=document.createElement('script');
    s.src='iachara-text-sanitizer.js?v=0.7.25';
    s.defer=true;
  ...
  function ensureSkillLayout(){
    ...
    l.rel='stylesheet';
    l.href='urban-skill-layout-v0724.css?v=0.7.25';
