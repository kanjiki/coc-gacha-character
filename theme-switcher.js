(()=>{
  ...
  const THEMES={persona:{href:'persona-theme.css?v=0.7.19',label:'COMIC / PHANTOM'},zzz:{href:'zzz-theme-v0715.css?v=0.7.19',label:'URBAN / ACTION'}};
  function applyTheme(name){
    ...
    if(badge)badge.textContent=`v0.7.19 // ${t.label} // 2026-08-18`;
    const footer=[...document.querySelectorAll('#resultCard footer span')].at(-1);if(footer)footer.textContent='TRPG LAB // CoC6 // v0.7.19';
