(()=>{
  ...
  const THEMES={persona:{href:'persona-theme.css?v=0.6.5',label:'COMIC / PHANTOM'},zzz:{href:'zzz-theme-v065.css?v=0.6.5',label:'URBAN / ACTION'}};
  function applyTheme(name){
    ...
    if(badge)badge.textContent=`v0.6.5 // ${t.label} // 2026-08-18`;
