(()=>{
  ...
  const THEMES={persona:{href:'persona-theme.css?v=0.6.0',label:'COMIC / PHANTOM'},zzz:{href:'zzz-theme.css?v=0.6.0',label:'URBAN / ACTION'}};
  function applyTheme(name){
    ...
    if(badge)badge.textContent=`v0.6.0 // ${t.label} // 2026-08-18`;
