(()=>{
  ...
  const THEMES={persona:{href:'persona-theme.css?v=0.7.5',label:'COMIC / PHANTOM'},zzz:{href:'zzz-theme-v075.css?v=0.7.5',label:'URBAN / ACTION'}};
  function applyTheme(name){
    ...
    if(badge)badge.textContent=`v0.7.5 // ${t.label} // 2026-08-18`;
    const footer=[...document.querySelectorAll('#resultCard footer span')].at(-1);if(footer)footer.textContent='TRPG LAB // CoC6 // v0.7.5';
