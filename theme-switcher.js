(()=>{
  ...
  const THEMES={persona:{href:'persona-theme.css?v=0.6.9',label:'COMIC / PHANTOM'},zzz:{href:'zzz-theme-v069.css?v=0.6.9',label:'URBAN / ACTION'}};
  function applyTheme(name){
    ...
    if(badge)badge.textContent=`v0.6.9 // ${t.label} // 2026-08-18`;
