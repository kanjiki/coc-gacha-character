(()=>{
  ...
  const THEMES={persona:{href:'persona-theme.css?v=0.6.4',label:'COMIC / PHANTOM'},zzz:{href:'zzz-theme-v064.css?v=0.6.4',label:'URBAN / ACTION'}};
  function applyTheme(name){
    ...
    if(badge)badge.textContent=`v0.6.4 // ${t.label} // 2026-08-18`;
