(()=>{
  ...
  function ensureRandomBuild(){
    ...
    s.src='random-build.js?v=0.7.26';
    s.defer=true;
  ...
  function ensureSkillLayout(){
    ...
    l.rel='stylesheet';
    l.href='urban-skill-layout-v0724.css?v=0.7.26';
